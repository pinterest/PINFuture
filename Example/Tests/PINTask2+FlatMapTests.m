...
describe(@"flatMap", ^{
    it(@"can return to a resolved value", ^{
        ...
        PINTask<NSString *> *taskB = [PINTask2<NSNumber *, NSString *> flatMap:taskA success:^PINTask<NSString *> * _Nonnull(NSNumber * _Nonnull fromValue) {
    ...
    it(@"can map to a rejected error", ^{
        ...
        PINTask<NSString *> *taskB = [PINTask2<NSString *, NSString *> flatMap:taskA success:^PINTask<NSString *> * _Nonnull(NSString * _Nonnull fromValue) {
